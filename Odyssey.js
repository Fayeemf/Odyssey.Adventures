...
function tackle() {
  ...
  if(miss == 1 ) {
    ...
    document.getElementById('message').innerHTML = " Odyssues used tackle ";
    var critical = Math.floor((Math.random() * 10) + 1);
      if(critical == 4){
        for(var x = 0; x < 2; x++){
          opHP = opHP - 5;
...
function flameThrower() {
  var miss = Math.floor((Math.random() * 10) + 1); // miss rate
  if(miss == 1 ) {
  document.getElementById('message').innerHTML = " Suitors's attack missed! " // attack missed
  }
  else {
  document.getElementById('message').innerHTML = " Suitor used flame thrower " // attack
    var critical = Math.floor((Math.random() * 10) + 1); // critical
      if(critical == 4){
...
function dragonClaw() {
  var miss = Math.floor((Math.random() * 10) + 1);
  if(miss == 1 ) {
    document.getElementById('message').innerHTML = " Suitor's attack missed! "
  }
  else {
  document.getElementById('message').innerHTML = " Suitor used dragon claw "
  var critical = Math.floor((Math.random() * 10) + 1);
    if(critical == 4){
      for(var x = 0; x < 2; x++){
        userHP = userHP - 20;
...
function ember() {
  ...
  document.getElementById('message').innerHTML = " Suitor used ember "
  var critical = Math.floor((Math.random() * 10) + 1);
    if(critical == 4){
      for(var x = 0; x < 2; x++){
        userHP = userHP - 10;
...
function growl() {
  ...
  document.getElementById('message').innerHTML = " Suitor used growl "
  var critical = Math.floor((Math.random() * 10) + 1);
    if(critical == 4){
      for(var x = 0; x < 2; x++){
        userHP = userHP - 5;
